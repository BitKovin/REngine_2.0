...
cmake -S "/repo" -B "/repo/build/linux" -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=Release -DCMAKE_TOOLCHAIN_FILE="/repo/cmake/toolchains/clang.cmake" -DGAME_NAME="StealthAction" -DSKIP_GAMEDATA_FINALIZE=1
