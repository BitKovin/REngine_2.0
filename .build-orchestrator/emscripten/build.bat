...
emcmake cmake -S "F:\Git\SdlWasmEngine" -B "F:\Git\SdlWasmEngine\build\emscripten" -G "Ninja" -DCMAKE_BUILD_TYPE=Release -DGAME_NAME="StealthAction" -DSKIP_GAMEDATA_FINALIZE=1
