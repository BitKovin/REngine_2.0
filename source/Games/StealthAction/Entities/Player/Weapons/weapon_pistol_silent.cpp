...
class weapon_pistol_silent : public WeaponFirearm {
public:


    weapon_pistol_silent() : WeaponFirearm()
    {
        params.ammoType = WeaponAmmoType::PistolBullets;
        params.modelPath = "GameData/models/player/weapons/pistol_silent/pistol_silent.glb";
        params.texturesLocation = "GameData/models/player/weapons/pistol_silent/pistol_silent.glb/";
        ...
        params.pitchModifier = 2.0f; // Modified in Update based on Silencer
        ...
        params.attackDelayTime = 1.25f;
        params.switchDelayTime = 1.2f;
...
REGISTER_ENTITY(weapon_pistol_silent, "weapon_pistol_silent")