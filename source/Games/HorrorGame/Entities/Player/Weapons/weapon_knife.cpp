...
class weapon_knife : public Weapon
{
public:
	...
	void LoadAssets()
	{
		...
		viewmodel->LoadFromFile("GameData/models/player/weapons/knife/knife.glb");
...
REGISTER_ENTITY(weapon_knife, "weapon_knife")