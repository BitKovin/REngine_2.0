...
class weapon_tommy : public Weapon
{
public:
	...
	void LoadAssets()
	{
		...
		viewmodel->LoadFromFile("GameData/models/player/weapons/tommy/tommy.glb");
		viewmodel->TexturesLocation = "GameData/models/player/weapons/tommy/tommy.glb/";
	...
	void PerformAttack()
	{
		...
		vec3 offset = RandomHelper::RandomPosition(1.0f);
